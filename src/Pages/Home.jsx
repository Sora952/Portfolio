...
const Home = () => {
  ...
  const greeting = "<strong>Salut à vous, visiteur !</strong> Je vous souhaite une bonne journée !";
    ...
    return (
      <div className={classes.root}>
        ...
        onInit={(typewriter) => {
          ...
          <p>De ce fait, je suis actuellement en formation développeur web et web mobile à la Wild Code School de Lyon, je me forme aux métiers du web, et surtout sur l'écosystème Javascript/NodeJS pour pouvoir parfaire mes connaissances en tant que développeur web FullStack.</p>
        ...
        <section style={{ marginTop: "30px", height: "100%", marginBottom: "30px"}}>
        <div style={{width: "80%", margin: "auto", marginTop: "30px"}}>
          <h3>Mon parcours professionnel: </h3>
          <p style={{overflowWrap: "break-word", marginTop: "20px", fontSize: "22px"}}>
            En cours d'écriture, en attendant <a style={{textDecoration: 'underline', color: "black", fontWeight: "600"}} href='https://www.linkedin.com/in/camillebueno/' target='_blank' rel='noreferrer noopener'>voila mon linkedin</a> où tout est déjà décrit.
          </p>
          </div>
        ...
        <div style={{width: "80%", margin: "auto", marginTop: "30px"}}>
          <h3 style={{paddingTop: "25px"}}>Voici quelques-uns de mes principaux projets: </h3>
          <Carousel />
        </div>
        <div>
